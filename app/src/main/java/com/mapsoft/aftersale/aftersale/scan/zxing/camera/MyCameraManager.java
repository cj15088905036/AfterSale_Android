...
package com.mapsoft.aftersale.aftersale.scan.zxing.camera;
...
public final class MyCameraManager {
    ...
    public static void init(Context context) {
        if (myCameraManager == null) {
            myCameraManager = new MyCameraManager(context);
        }
    }
    ...
    public void openDriver(SurfaceHolder holder) throws IOException {
        if (camera == null) {
            setCamera(open(Camera.CameraInfo.CAMERA_FACING_BACK));//获得后置摄像头OpenCamera
            if (camera == null) {
