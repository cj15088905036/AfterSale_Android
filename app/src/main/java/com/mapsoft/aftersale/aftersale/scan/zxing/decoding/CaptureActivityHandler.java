...
import com.mapsoft.aftersale.aftersale.scan.zxing.view.ViewfinderResultPointCallback;
  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      ...
      case R.id.decode_failed:
        ...
        state = State.PREVIEW;
        MyCameraManager.get().requestPreviewFrame(decodeThread.getHandler(), R.id.decode);
        break;
      case R.id.return_scan_result:
        Log.d(TAG, "Got return scan_ed result message");
