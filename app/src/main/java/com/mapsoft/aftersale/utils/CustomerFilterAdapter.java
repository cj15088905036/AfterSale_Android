...
public class CustomerFilterAdapter extends BaseAdapter implements Filterable {
    ...
    public CustomerFilterAdapter(Context context, int resource, List<String> list) {
