...
/**
 * Created by Even_Kwok on 2017/2/6.
 */

public class LogUtil implements UncaughtExceptionHandler {
   ...
   /* private void restartApplication() {
    ...
    public boolean sendEmaill(Throwable ex) {
            ...
            public void run() {
                try {
                    EmailUtils.SendEmail(
                            ...
                            "3183792521@qq.com",
                            "25",
                            "图软掌上运维 " + curVersion + " 日志" + "(" + sp.getString("user_name", "") + ")",
                            sb.toString()
                    );
                } catch (Exception e) {
                    e.printStackTrace();
